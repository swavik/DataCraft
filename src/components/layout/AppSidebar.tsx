...
const AppSidebar = ({ 
  ...
  return (
    <aside 
      className={cn(
        "h-full bg-[hsl(var(--sidebar-bg))] border-r border-[hsl(var(--sidebar-border))] flex flex-col",
    ...
    >
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        {!isCollapsed && (
          <>
            <div className={cn(
              "mx-3 mb-2 px-3 py-2.5 flex items-center gap-2 text-xs font-semibold uppercase tracking-wider rounded-lg",
                  ...
                  {history.map((dataset) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 p-1.5 hover:bg-destructive/10 rounded-lg"
                      >
      ...
      <div className="p-3 border-t border-[hsl(var(--sidebar-border))]">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg"
        >
